...
spond_api_functions = ["check_login", "get_all_groups"]
...
def spond_api():
    ...
    if not ("username" in body and "password" in body and "function" in body and body["function"] in spond_api_functions):
